...
/datum/admin_help/proc/message_no_recipient(msg)
	...
	var/admin_msg = fieldset_block("[span_adminhelp("Ticket [ticket_href("#[id]", ref_src)]")]", "<b>: [linked_reply_name(ref_src)] [full_monty(ref_src)]:</b> [span_linkify("[keywords_lookup(msg)]")]", "boxed_message red_box")
