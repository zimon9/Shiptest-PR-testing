/datum/species/ipc // im fucking lazy mk2 and cant get sprites to normally work
	...
	species_age_min = 0
	species_age_max = 300
	species_traits = list(HAIR,NOTRANSSTING,NOEYESPRITES,NO_DNA_COPY,TRAIT_EASYDISMEMBER,NOZOMBIE,MUTCOLORS,NOHUSK,NOMOUTH) //all of these + whatever we inherit from the real species
